...
--> statement-breakpoint
CREATE UNIQUE INDEX "admin_private_daily_imports_date_station_shift_idx" ON "admin_private_daily_imports" ("date","station_name","shift");--> statement-breakpoint
CREATE UNIQUE INDEX "availability_user_date_shift_idx" ON "availability" ("user_id","date","shift_type");--> statement-breakpoint
CREATE UNIQUE INDEX "form_completions_date_source_ref_slot_idx" ON "form_completions" ("date","source","ref_id","slot");--> statement-breakpoint
CREATE UNIQUE INDEX "hidden_shifts_date_station_idx" ON "hidden_shifts" ("date","station_id");--> statement-breakpoint
CREATE UNIQUE INDEX "placement_notes_user_date_uniq" ON "placement_notes" ("user_id","date");--> statement-breakpoint
CREATE UNIQUE INDEX "published_weeks_week_start_idx" ON "published_weeks" ("week_start");--> statement-breakpoint
CREATE UNIQUE INDEX "schedules_date_station_idx" ON "schedules" ("date","station_id");--> statement-breakpoint
ALTER TABLE "availability" ADD CONSTRAINT "availability_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
